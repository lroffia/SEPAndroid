...
public class SPARQL11Properties {
     ...
     * The Constant logger.
     */
    private static final Logger logger = LogManager.getLogger("SPARQL11Properties");
    ...
    public SPARQL11Properties(InputStream stream) throws SEPAPropertiesException {
        this.propertiesFile = propertiesFile;

        try {
            doc = new JsonParser().parse(new InputStreamReader(stream)).getAsJsonObject();
            ...
            throw new SEPAPropertiesException(new Exception("USING DEFAULTS. Edit \"" + defaultsFileName + "\" and rename it to\"" + propertiesFile + "\""));
        }
    }
    ...
    protected void defaults() {
        ...
        parameters.add("concurrentRequests", new JsonPrimitive(5));
    ...
    public int getMaxConcurrentRequests() {
        return parameters.get("concurrentRequests").getAsInt();
    }
